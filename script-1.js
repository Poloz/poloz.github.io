...
dict.calendar = {
    div:'-',
    table:{
        '2011-10-31':'Õýллоуин — канун дня всеõ святûõ',
        '2011-11-01':'день судебного пристава',
        '2011-11-19':'день ракетнûõ воéск и артиллерии',
        '2011-12-12':'день конституöии россиéскоé Ôедераöии',
...
-function () {
    var d = document, year_offset = 5,
        ...
        lang = {
            ...
            mm:['янв', 'ôев', 'мар', 'апр', 'маé', 'иþн', 'иþл', 'авг', 'сен', 'окт', 'ноя', 'дек'],
...
* }
         * @el:string
         * @idxs:array - только для ýлемента select
         */
